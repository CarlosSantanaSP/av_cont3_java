...
import br.com.carlossantana.avaliacao.continuada3.models.SalaryAccount;
import br.com.carlossantana.avaliacao.continuada3.models.SavingsAccount;
import br.com.carlossantana.avaliacao.continuada3.models.CurrentAccount;
import br.com.carlossantana.avaliacao.continuada3.models.Account;
...
public class CashMachine extends javax.swing.JFrame {
    ...
    public void openClientAccount() {
        ...
        List<Account> bankAccounts = this.jdbcTemplate.query("SELECT * FROM bankAccount WHERE fkClient=?;",
        ...
        } else if (account.getTypeBankAccount().equals("SalaryAccount")) {
            this.bankAccount = new SalaryAccount(account.getIdBankAccount(), account.getFkClient(), account.getBalanceBankAccount(), "SalaryAccount");
        } else {
    ...
    private void btDepositActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDepositActionPerformed
        ...
        bankAccount.deposit(depositValue, lbDepositResult);
        updateScreen();
    ...
    private void btTakeOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btTakeOutActionPerformed
        ...
        bankAccount.takeOut(takeOutValue, lbTakeOutResult);
        updateScreen();
